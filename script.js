...
function createStars() {
    ...
    const starCount = 100; // More stars!
...
function checkAnswers() {
    ...
    // Validation Logic
    // Name: "روزي" (case-insensitive for English if typed, but requesting Arabic)
    ...
    // The user said: 'السؤال الأول: "من صاحبة العيد ميلاد؟" → يجب إدخال "روزي"'
    // I will match 'روزي' loosely.
    const isNameValid = name.includes('روزي') || name.toLowerCase().includes('rozy') || name.toLowerCase().includes('rozi');
